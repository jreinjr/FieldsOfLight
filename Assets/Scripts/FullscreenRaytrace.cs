...
[AddComponentMenu("Effects/FullscreenRaytrace")]
public class FullscreenRaytrace : SceneViewFilter
{
    [SerializeField]
    private EyeCollection _eyeCollection;
    public EyeCollection eyeCollection
    {
        get
        {
            
            return _eyeCollection;
        }
    }

    public Texture2D rgb_tex;
    public Texture2D z_tex;
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        EffectMaterial.SetMatrix("_eyeExtrinsics", eyeCollection.eyes[0].Extrinsics);
        EffectMaterial.SetMatrix("_eyeIntrinsics", eyeCollection.eyes[0].Intrinsics);
        EffectMaterial.SetVector("_eyeUV", eyeCollection.eyes[0].UV);
